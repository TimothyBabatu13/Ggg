# dApp Variance of Number between two given values
<a id="readme-top"></a>

<!-- PROJECT LOGO -->
## About
<p>
    This is decentralized application (dapp) for getting the variance of numbers that exist between two given values. powered by <a href="https://docs.cartesi.io/cartesi-rollups/1.3/">cartesi</a> rollups technology.
</p>
...
#### Advanced handlers
```
description — generate the variance between the values that exist between two given numbers.
